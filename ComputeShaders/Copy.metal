...
#define INSTANTIATE_FROM_TYPE(src_idx, src_type, dst_type) \
    instantiate_kernel("CopyInplaceGPU_" #src_idx "_0", copy_gg_nd1, src_type, dst_type); \
    instantiate_kernel("CopyInplaceGPU_" #src_idx "_1", copy_gg_nd2, src_type, dst_type); \
    instantiate_kernel("CopyInplaceGPU_" #src_idx "_2", copy_gg_nd3, src_type, dst_type); \
    instantiate_kernel("CopyInplaceGPU_" #src_idx "_3", copy_gg, src_type, dst_type); \
